...
Function three, `codon_extractor()` converts a nucleic acid sequence into it's respective codons. It takes a string input and returns a new string containing the codons of the input sequence. 
